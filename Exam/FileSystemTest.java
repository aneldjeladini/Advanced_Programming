...
class File implements IFile{ //component
    String fileName;
    long fileSize;
...
class Folder implements IFile{ //composit
    String folderName;
    List<IFile> children;
    ...
    @Override
    public void sortBySize() {
        children.sort(Comparator.comparingLong(IFile::getFileSize));
        children.forEach(IFile::sortBySize);
    }
